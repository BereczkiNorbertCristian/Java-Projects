...
public class ProgramState implements Serializable {
    ...
    private Stack<IToyMap<String,Integer>> allSymTables=null;
    private ProcTable procTable=null;

    public String getFileSerializableName() {
        return fileSerializableName;
    }

    public Stack<IToyMap<String, Integer>> getAllSymTables() {
        return allSymTables;
    }

    public void setAllSymTables(Stack<IToyMap<String, Integer>> allSymTables) {
        this.allSymTables = allSymTables;
    }
