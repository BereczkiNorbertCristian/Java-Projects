...
public class Main extends Application {
    ...
    public void createRightPlusPane(VBox rightPlusPane){
        ...
        TableColumn<Pair<Integer,Integer>,String> leftColumn=new TableColumn<>("LockIndex");
        TableColumn<Pair<Integer,Integer>,String> rightColumn=new TableColumn<>("LockValue");
